...
class SocialUseraddLoadingfemaleState extends SocialStates {}
class SocialUseraddLoadingState extends SocialStates {}
class SocialUseraddchilderenLoadingState extends SocialStates {}
class SocialUseraddErrorState extends SocialStates {}
class SocialUseraddchilderenErrorState extends SocialStates {}
class SocialGetUserchildLoadingState extends SocialStates {}
class SocialGetUserchildSuccessState extends SocialStates {}
class SocialGetUserfemaleSuccessState extends SocialStates {}
class SocialUseraddfemaleErrorState extends SocialStates {}


class SocialGetUserchildErrorState extends SocialStates {
  final String error;
  SocialGetUserchildErrorState(this.error);
}
class SocialUseraddSucessState extends SocialStates {}
class SocialUserChildrenSucessState extends SocialStates {}

class ChangeCounterState extends SocialStates{
